...
###‘***’ means statistically significant at 0% level of significance\

###‘**’ means statistically significant at 0.001% level of significance\

###‘*’ means statistically significant at 1% level of significance\

###‘*’ means statistically significant at 5% level of significance\

###‘.’ means statistically significant at 10% level of significance\

###‘ ’ means statistically significant at 100% level of significance(there was no statistical significance)  
\
```{r ANOVA}
for(i in levels(ldf$Parameter)){
  par <- i
